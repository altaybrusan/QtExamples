...
void MainWindow::closeEvent(QCloseEvent *event)
{
    ...
    if (okToClearData()) {
        ...
        settings.setValue(CurrentTaskPathSetting,
                model->pathForIndex(ui->treeView->currentIndex()));
        event->accept();
    }
    else
        event->ignore();
...
void MainWindow::updateUi()
{
    ...
    bool enable = ui->treeView->currentIndex().isValid();
#ifdef CUSTOM_MODEL
...
void MainWindow::createModelAndView()
{
    ...
    ui->treeView->setItemDelegateForColumn(0, new RichTextDelegate);
...
{
    fileNewAction = createAction(":/images/filenew.png", tr("New"),
            this, QKeySequence::New);
    fileOpenAction = createAction(":/images/fileopen.png", tr("Open..."),
            this, QKeySequence::Open);
    fileSaveAction = createAction(":/images/filesave.png", tr("Save"),
            this, QKeySequence::Save);
    fileSaveAsAction = createAction(":/images/filesave.png",
            tr("Save As..."), this
...
#endif
    editStartOrStopAction = createAction(":/images/0.png", tr("S&tart"),
